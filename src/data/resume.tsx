    ...
    work: [
        {
            ...
            description:
                "Frontend work on a production dashboard, shipping on a weekly release cycle in an Agile team.",
            bullets: [
                "Built the Shopify Coupons Listing module in React and Tailwind, factoring the repeated table, filter, and empty-state patterns into reusable components — cutting frontend development time for new features by 30%.",
                "Integrated Link Tracker into the core dashboards over REST APIs, so engagement data appeared alongside the rest of the metrics rather than in a separate tool.",
                "Moved global state into Zustand and validated API responses with Zod schemas at the fetch boundary, reducing runtime UI errors by 25%.",
